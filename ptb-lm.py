...
# GENERATE SAMPLES
save_state_dict_path = os.path.join(args.save_dir, 'best_params.pt') 
...
hidden = model.init_hidden()
hidden = hidden.to(device)
input_tokens_minibatch = valid_data[:,19] #for testing purpose 
samples = model.generate(input,hidden,generated_seq_len = 35)
